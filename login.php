	...
	<head>
		...
		<style>
		body{
			background:#ffdead;background:linear-gradient(to right,#f8f8f8,#f8f0f0,#f0f8f8);
		}
	...
	<body>
		...
		<p style="font-family:helvetica;font-size:16px;color:#191970;padding-top:5px">Agronomist & Farmer Login</p>
			...
			<input type="number"placeholder="Phone number"name="fon" id="usern" onkeyup="checkkeys(event)"autocomplete="off"></p><br><br>
